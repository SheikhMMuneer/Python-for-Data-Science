...
# Matix is like Table Rows and Column
# (*,*,'C')  start from row for putting data  and (*,*,'F')
...
rshape = np.reshape(mydata,(5,4))   # 5 rows and 4 columns
print(rshape)

matr1 = np.reshape(mydata,(5,4),order='C')   # C is for Rows first
print(matr1)
...
matr2 = np.reshape(mydata,(5,4),order='F')   # C is for Column first
print(matr2)
...
# Matrix Operation
print("FieldGoals" , FieldGoals)
print("Games" , Games)

print("FieldGoals / Games" , np.matrix.round(FieldGoals/Games,2)*100)
