...
# S IS FOR SQUARE , ms = marker size , Ls = Lines
# matplotlib inline
plt.rcParams['figure.figsize'] = 8,8  # this will enlarge
plt.plot(Salary[0],c='Black',ls='--',marker='s',ms=17)
plt.show()


#Xticks
print("Seasons" , Seasons)
plt.rcParams['figure.figsize'] = 8,6  # this will enlarge
plt.plot(Salary[0],c='Black',ls='--',marker='s',ms=17)
plt.xticks(list(range(0,8)),Seasons)
plt.show()

#vertical  rotation of Column Heading
print("Seasons" , Seasons)
plt.rcParams['figure.figsize'] = 8,6  # this will enlarge
plt.plot(Salary[0],c='Black',ls='--',marker='s',ms=17,label=Players[0])
...
plt.plot(Salary[3],c='Yellow',ls='--',marker='D',ms=7,label=Players[3])
plt.legend(loc = 'upper left' , bbox_to_anchor = (1,0))   # upper right
plt.xticks(list(range(0,8)),Seasons,rotation='vertical')
plt.show()


plt.rcParams['figure.figsize'] = 10,10  # this will enlarge
...
plt.plot(Games[3],c='Yellow',ls='--',marker='D',ms=7,label=Players[3])
plt.plot(Games[4],c='Magenta',ls='--',marker='D',ms=7,label=Players[4])
plt.plot(Games[5],c='Blue',ls='--',marker='D',ms=7,label=Players[5])
plt.legend(loc = 'upper left' , bbox_to_anchor = (1,0))   # upper right
plt.xticks(list(range(0,8)),Seasons,rotation='vertical')
plt.show()
