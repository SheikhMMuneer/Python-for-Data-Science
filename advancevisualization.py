...
# Matrix
MinutesPlayed = np.array([KobeBryant_MP, JoeJohnson_MP, LeBronJames_MP, CarmeloAnthony_MP, DwightHoward_MP, ChrisBosh_MP, ChrisPaul_MP,
...
# Matrix
FieldGoalAttempts = np.array([KobeBryant_FGA, JoeJohnson_FGA, LeBronJames_FGA, CarmeloAnthony_FGA, DwightHoward_FGA, ChrisBosh_FGA,
...
def myplot(playerlist):
    Col = {"KobeBryant": "Black", "JoeJohnson": "Red", "LeBronJames": "Green", "CarmeloAnthony": "Yellow", "DwightHoward": "Purple", "ChrisBosh": "Purple","ChrisPaul": "Purple", "KevinDurant": "Blue", "DerrickRose": "Orange", "DwayneWade": "Gray"}
    Mrk =  {"KobeBryant": "s", "JoeJohnson": "o", "LeBronJames": "D", "CarmeloAnthony": "^", "DwightHoward": "s", "ChrisBosh": "o","ChrisPaul": "D", "KevinDurant": "^", "DerrickRose": "s", "DwayneWade": "o"}
    for name in playerlist:
        plt.plot(Games[Pdict[name]], c=Col[name], ls='--', marker=Mrk[name], ms=7, label=name)
    plt.legend(loc='upper left', bbox_to_anchor=(1, 1))  # upper right
    plt.xticks(list(range(0, 8)), Seasons, rotation='vertical')
    plt.show()
...
# Advanced Visualization
def myplot1(data,playerlist=Players):
    Col = {"KobeBryant": "Black", "JoeJohnson": "Red", "LeBronJames": "Green", "CarmeloAnthony": "Yellow", "DwightHoward": "Green", "ChrisBosh": "Purple","ChrisPaul": "Gray", "KevinDurant": "Blue", "DerrickRose": "Orange", "DwayneWade": "Gray"}
    Mrk =  {"KobeBryant": "s", "JoeJohnson": "o", "LeBronJames": "D", "CarmeloAnthony": "^", "DwightHoward": "s", "ChrisBosh": "o","ChrisPaul": "D", "KevinDurant": "^", "DerrickRose": "s", "DwayneWade": "o"}
    for name in playerlist:
...
myplot1(Points,['KobeBryant','LeBronJames','DerrickRose'])
myplot1(Salary,['KobeBryant','LeBronJames','DerrickRose'])
myplot1(Salary)


# Advanced Visualization
def myplot2(data,playerlist=["JoeJohnson"]):
    Col = {"KobeBryant": "Black", "JoeJohnson": "Red", "LeBronJames": "Green", "CarmeloAnthony": "Yellow", "DwightHoward": "Green", "ChrisBosh": "Purple","ChrisPaul": "Gray", "KevinDurant": "Blue", "DerrickRose": "Orange", "DwayneWade": "Gray"}
    Mrk =  {"KobeBryant": "s", "JoeJohnson": "o", "LeBronJames": "D", "CarmeloAnthony": "^", "DwightHoward": "s", "ChrisBosh": "o","ChrisPaul": "D", "KevinDurant": "^", "DerrickRose": "s", "DwayneWade": "o"}
    for name in playerlist:
        plt.plot(data[Pdict[name]], c=Col[name], ls='--', marker=Mrk[name], ms=7, label=name)
...
myplot2(Salary,["KobeBryant","LeBronJames"])
