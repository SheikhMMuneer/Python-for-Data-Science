...
print("List of Games[0]" , Games[0])
print("List of Games[1]" , Games[1])
print("List of Games[2][9]" , Games[2][9])
print("List of Games[2][-1]" , Games[2][-1])
print("List of Points" , Points[6])
...
print("Pdict" , Pdict)
print("Pdict['KobeBryant'] = " , Pdict['KobeBryant'])
print("Pdict['DerrickRose'] = " , Pdict['DerrickRose'])
print("Pdict['KobeBryant'] = " , Pdict['KobeBryant'])
print("Pdict['JoeJohnson'] = " , Pdict['JoeJohnson'])
print("Sdict['2012'] = " , Sdict['2012'])


print("Games[Pdict['DerrickRose']][Sdict['2012']]= " , Games[Pdict['DerrickRose']][Sdict['2012']])  #  Matrix[row][col]
print("Games[Pdict['JoeJohnson']][Sdict['2012']]= " , Games[Pdict['JoeJohnson']][Sdict['2012']])
